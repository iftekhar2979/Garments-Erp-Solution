...
const Modal = ({modalId,desc,id,handleDelete,item}) => {
...
<div className="modal">
  <div className="modal-box relative">
    ...
    <h3 className="text-lg font-bold">Do you Want to Remove {item} : {desc}</h3>
    
    <div className="modal-action">
     <a onClick={()=>handleDelete(id)} className="btn">Yes</a>
    </div>
  </div>
</div>
</>
