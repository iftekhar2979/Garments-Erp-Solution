...
const deliveryChalan = createSlice({
...
export default deliveryChalan.reducer
export const { changeSize,restSizeChanging,id_ColorName_SizeName_StyleChanging,totalQuantityCalculation,idGenerator } = deliveryChalan.actions